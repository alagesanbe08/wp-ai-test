...
class BlackForestLabs implements TextToImage {
	protected static $url = 'https://api-inference.huggingface.co/models/black-forest-labs/FLUX.1-dev';
	...
	public static function handleResponse( $response ) {
		...
		$file_name = 'BlackForestLabs/black-forest-labs.' . self::getImageExtension( $response );
