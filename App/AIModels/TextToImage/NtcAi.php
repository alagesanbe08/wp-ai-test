...
class NtcAi implements TextToImage {
	protected static $url = 'https://api-inference.huggingface.co/models/ntc-ai/SDXL-LoRA-slider.ultra-realistic-illustration';
	...
	public static function handleResponse( $response ) {
		...
		$file_name = 'Ntc/ntc.' . self::getImageExtension( $response );
